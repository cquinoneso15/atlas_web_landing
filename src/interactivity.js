...
info.update = function (props) {
    ...
    if (biv) {
        ...
        this._div.innerHTML += (props
            ? '<b>' + props.name + '</b><br /><span i18n="' + selected_values["justice"] + '"></span> ' + props['value_' + X].toFixed(2) + '&nbsp;<span i18n="' + props['value_desc_' + X] + '"></span> (<span i18n="' + props['hilo_' + X] + '"></span>)<br /><span i18n="pop"></span> ' + props.value_pop.toFixed(2) + '&nbsp;<span i18n="' + props['value_desc_pop'] + '"></span> (<span i18n="' + props.hilo_pop + '"></span>)'
            : '');
    } else {
        this._div.innerHTML += (props
